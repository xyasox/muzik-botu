...
# ─────────────────────────────────────────────────────────────
#  TOKEN VE ŞİFRELER — Railway'de "Variables" kısmına girilecek
#  Bu satırlara hiçbir şey yazma, olduğu gibi bırak!
# ─────────────────────────────────────────────────────────────
...
try:
    ...
    sp = None
    print("Spotify baglantisi kurulamadi. SPOTIFY bilgilerini kontrol et.")
